    ...
    <div className="categories">
        <div className="col">
            ...
            <div className="row">
                ...
                <button><Link className='link' to='/products/1'>Adventure</Link></button>
            </div>
        </div>
        ...
        <div className="col">
            <div className="row">
                ...
                <button><Link className='link' to='/products/1'>Shooting</Link></button>
            </div>
        </div>
            ...
            <div className="row">
                ...
                <div className="col">
                    <div className="row">
                        ...
                        <button><Link className='link' to="/products/1">Racing</Link></button>
                    </div>
                </div>
            </div>
            <div className="row">
                <img src="https://wallpaperaccess.com/full/9143.png" alt="" />
                <button><Link className='link' to="/products/1">Action</Link></button>
            </div>
        </div>
    </div>
  )
